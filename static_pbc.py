...
from util.util import data_participation_each_node, DatasetSplit, WorkerSampler
import numpy as np
import random
from model.model import Model

def static_dynamics_pbc():
    stat = stats_collector(prefix=prefix + '_static')
    ...
    for seed in seeds:
        ...
        dict_users, participation_prob_each_node, actual_label_distributions_each_node, num_labels = data_participation_each_node(data_train, num_clients)        
